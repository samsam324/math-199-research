...
We claim three contributions, each bounded against prior work as cited. First, two standard pair screening tools manufacture the appearance of
...
surviving result ends up cutting against itself. The methodological lesson is the one
that holds across all three: trust a cointegration or mean reversion screen only after it
fails on a placebo built to reproduce the claim if the claim is mechanical.
