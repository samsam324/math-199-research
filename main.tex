...
separate constructed cointegrated pairs from random walks. Second, extending
...
$8\%$/year breakage rate consistent with historical crypto delisting frequency. To our
knowledge, this joint treatment on crypto pair spreads is new, though each ingredient has
prior art in adjacent domains.
...
Lu, C.-Y., Lai, S.-C., et~al. (2021). Structural break-aware pairs trading strategy using
deep reinforcement learning. \emph{Journal of Supercomputing}, 78, 3843--3882.
