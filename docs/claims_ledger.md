...
| Survivorship-adjusted Sharpe (no-stop+breaker, UPPER bound) | retains ~96%/88% at 8%/19%/yr, positive at 59%/yr; no-breaker negative; smooth ramp optimistic vs real -65/-91% gaps | survivorship_adjusted_sharpe.csv |
