...
backtest-overfitting literature~\cite{bailey2014dsr, harvey2016crosssection} one step earlier, from the strategy
...
Lee~\cite{avellaneda2010statistical}, and the taxonomy in Krauss~\cite{krauss2017review} define
what we test. Our dynamic hedge is the state-space pairs model of Elliott et
