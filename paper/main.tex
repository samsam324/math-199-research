...
to $-117\%$. The breaker blunts the tail but does not remove it, and at the book level it is what makes the
no-stop rule survivorship-robust. Injecting permanent delisting-scale breaks ($\sim$$86\%$ leg
blowup, never reverting) into a fraction of the 40 pairs each quarter, the deployable
no-stop-plus-breaker book keeps about $95\%$ of its monthly Sharpe at an $8\%$-per-year attrition
rate and $88\%$ at $19\%$/yr, and stays positive even at $59\%$/yr; the same book without the breaker
turns negative by that rate. Realized delisting among liquid top-50 names runs far below even the
$8\%$/yr stress, so the survivorship haircut on the $\sim$$1.0$ figure is small. A fully
point-in-time universe of every delisted coin is still beyond our data, but the tail is bounded,
not unmodeled.
