...
across all four symbols, the signal correlates $+0.03$ with the per-order post-vs-cross
...
with and without the structural-break circuit breaker. Without the breaker, the Sharpe declines steadily and crosses zero only near a $46\%$/year
