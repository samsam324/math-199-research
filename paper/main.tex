...
al.~\cite{elliott2005pairs}, built on Engle-Granger cointegration~\cite{engle1987cointegration}. The contribution is a placebo that two standard screens fail.
...
A few conventions hold throughout. Inference uses Newey-West HAC standard errors, because overlapping
