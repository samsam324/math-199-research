...
shows the raw backtest is untrustworthy. The paper's thesis has turned on our own surviving result.

The pre-registration had a second arm, which we report in full. A single selection over the whole
pre-2025-06 history qualified only two pairs (long-horizon reversion in the tradable band is
