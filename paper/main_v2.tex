...
frequency dependent, taking the clean test's random walk placebo at its nominal $5\%$ size. This reshaped view makes visible what
...
of $+0.12$ to $+0.16$ for BTC and ETH), and $77$ to $90\%$ of the liquidity that leaves the best
...
$\sim$$11$ to $48\%$ contemporaneously to near zero by $30$ seconds, across BTC/ETH/SOL/AVAX
...
\caption{Cancellations dominate trades in best-level liquidity withdrawal: $77$ to $90\%$ (about $80\%$ for BTC, ETH, SOL; $90\%$ for AVAX) of
...
dominates across all four majors and both sizes: the L3-from-L2 signal-timed rule is more expensive than crossing in every
